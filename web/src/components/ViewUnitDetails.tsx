                ...
                <div className="mt-8">
                  ...
                  <div className="py-3 grid grid-cols-3 mb-4">
                    <section className="flex flex-col">
                      <section className="flex flow-row justify-between">
                        <div className="font-md text-xs text-gray-500 tracking-wide">
                          Unit No
                        </div>
                        <div className="font-md text-xs text-gray-500 tracking-wide font-semibold ">
                          {projectDetails?.projectName}
                        </div>
                      </section>
                      <section className="flex flow-row justify-between">
