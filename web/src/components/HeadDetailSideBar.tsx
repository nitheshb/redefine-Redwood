              ...
              <li className="relative">
                ...
                >
                  <span className="flex items-center ml-1">
                    ...
                    <span className="text-md font-bold pl-2 ">
                      Active Leads
                    </span>
                  </span>
                  <span className="flex ml-auto items-bottom">
                ...
                <ul className="px-1">
                  {' '}
                  {['In Progress', 'Booking'].map((data, inx) => (
              ...
              <li className="relative">
                ...
                >
                  <span className="flex items-center ml-1">
                    ...
                    <span className="text-md font-bold pl-2 ">Archive</span>
                  </span>
                  <span className="flex ml-auto items-bottom">
                    <span
                      // style={{ color: '#058527' }}
                ...
                <ul className="px-1">
                  {' '}
                  {['RNR', 'Dead', 'Blocked', 'Not Interested'].map(
                    (data, inx) => (
                      <li className="relative" key={inx}>
                        <Link
                          className={
