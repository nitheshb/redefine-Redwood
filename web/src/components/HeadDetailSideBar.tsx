            ...
            <li className="relative ">
              ...
              >
                <span className="flex items-center">
                  ...
                  <span className="text-sm pl-1">Today Activity</span>
                </span>
                <span className="flex ml-auto items-bottom">
                ...
                <li className="relative ">
                  ...
                  >
                    <span className="flex items-center">
                      ...
                      <span className="text-sm pl-1">Today Team Activity</span>
                    </span>
                    <span className="flex ml-auto items-bottom">
                      <span
                        // style={{ color: '#058527' }}
                  ...
                  <li className="relative">
                    ...
                    >
                      <span className="flex items-center">
                        ...
                        <span className="text-sm pl-[6px]">Bank Details</span>
                      </span>
                      <span className="flex ml-auto items-bottom">
                        <span
                          // style={{ color: '#058527' }}
                  ...
                  <li className="relative">
                    ...
                    >
                      <span className="flex items-center">
                        ...
                        <span className="text-sm pl-[6px]">Payment Plan</span>
                      </span>
                      <span className="flex ml-auto items-bottom">
                        <span
                          // style={{ color: '#058527' }}
                  ...
                  <li className="relative">
                    ...
                    >
                      <span className="flex items-center">
                        ...
                        <span className="text-sm pl-[6px]">Brouchers</span>
                      </span>
                      <span className="flex ml-auto items-bottom">
                        <span
                          // style={{ color: '#058527' }}
